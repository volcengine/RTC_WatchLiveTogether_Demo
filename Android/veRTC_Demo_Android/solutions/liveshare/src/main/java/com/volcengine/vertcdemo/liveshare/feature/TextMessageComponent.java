...
public class TextMessageComponent {
    ...
    public void onUserJoin(JoinRoomInform inform) {
        ...
        String msg = Utilities.getApplicationContext().getString(R.string.user_join_room_tip, userName);
    ...
    public void onUserLeave(LeaveRoomInform inform) {
        ...
        String userName = user.userName;
        String msg = Utilities.getApplicationContext().getString(R.string.user_leave_room_tip, userName);
        showSystemMessage(msg);
    }
