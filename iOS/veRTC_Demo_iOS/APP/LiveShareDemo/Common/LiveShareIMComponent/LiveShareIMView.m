...
@interface LiveShareIMView ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) UITableView *roomTableView;

@end

@implementation LiveShareIMView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    LiveShareIMCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LiveShareIMCellID" forIndexPath:indexPath];
...
- (UITableView *)roomTableView {
    if (!_roomTableView) {
        ...
        [_roomTableView registerClass:LiveShareIMCell.class forCellReuseIdentifier:@"LiveShareIMCellID"];
